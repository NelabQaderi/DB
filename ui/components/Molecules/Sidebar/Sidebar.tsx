  ...
  return (
    ...
    >
      ...
      <AppShell.Navbar p="md">
        ...
        <Button component={Link} href="/classes" mb={5} fullWidth color="green">
          Classes
        </Button>
        <Button
          component={Link}
        ...
        <Button component={Link} href="/report" mb={5} fullWidth color="green">
          Report
        </Button>
        <Button component={Link} href="/logout" mb={5} fullWidth color="green">
          Log Out
        </Button>
      </AppShell.Navbar>
